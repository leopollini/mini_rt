...
t_vec3_d	rft_refract(const t_vec3_d uv, const t_vec3_d n, double t)
{
	...
	r_out_perp = v3d_scal(v3d_sum_2(uv, v3d_scal(n,
					double_min(v3d_dot(v3d_anti(uv), n), 1.0))), t);
	return (v3d_normalize(v3d_sum_2(r_out_perp, v3d_scal(n,
...
int	metal_manager(t_ray *r, t_gameobject *gm)
{
	...
	refl.dir = v3d_specular(v3d_anti(r->dir),
			r->data.point_normal);
